  ...
  return (
    <div className="flex-1 flex flex-col h-full text-brand-50 overflow-hidden animate-in fade-in zoom-in-95 duration-700 rounded-3xl relative">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-10 scroller relative z-10 space-y-8 md:space-y-12">
         ...
         {/* Hero Block */}
         <div className="relative bg-brand-950/50 backdrop-blur-xl border border-brand-800/50 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 lg:p-14 shadow-2xl overflow-hidden group">
           ...
           <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             <div>
               ...
               <h3 className="text-2xl md:text-4xl lg:text-5xl font-light text-white mb-4 md:mb-8 tracking-tight leading-tight">Indulge in the Pelješac style of life.</h3>
               <p className="text-base md:text-xl text-brand-300 leading-relaxed font-light mb-6">
         ...
         {/* Quote Section */}
         <div className="relative bg-gradient-to-r from-brand-900/40 to-brand-950/40 backdrop-blur-md border border-brand-800/30 rounded-[2rem] p-6 md:p-10 mt-8 md:mt-12 flex flex-col items-center text-center">
            <Quote className="w-8 h-8 md:w-12 md:h-12 text-brand-primary/40 mb-4 md:mb-6" />
            <p className="text-lg md:text-2xl lg:text-3xl text-white font-light italic leading-relaxed max-w-4xl tracking-wide">

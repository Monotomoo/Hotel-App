    ...
    <div className="flex-1 flex flex-col h-full text-brand-50 overflow-hidden animate-in fade-in zoom-in-95 duration-700 rounded-3xl relative">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-10 scroller relative z-10 space-y-6 md:space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          <div className="relative bg-brand-950/40 backdrop-blur-xl border border-brand-800/50 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 lg:p-10 shadow-2xl flex flex-col justify-center">
              <h3 className="text-xl md:text-2xl font-light text-white mb-4 md:mb-5 flex items-center gap-3">
                 <ChefHat className="w-6 h-6 md:w-7 md:h-7 text-brand-primary" />
                 A Culinary Tradition
              </h3>
              <p className="text-brand-300 leading-relaxed text-sm md:text-base font-light mb-6">
        ...
        {/* The Origin Story */}
        <div className="relative bg-gradient-to-r from-brand-900/40 to-brand-950/40 backdrop-blur-md border border-brand-800/30 rounded-[1.5rem] p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 text-center md:text-left">
           <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-brand-primary/10 flex items-center justify-center shrink-0 border border-brand-primary/30">
               <History className="w-6 h-6 md:w-8 md:h-8 text-brand-primary" />
           </div>
           <div>
              <h4 className="text-lg md:text-xl text-white font-light mb-2 md:mb-3">The Captain's Legacy</h4>
              <p className="text-brand-300 leading-relaxed font-light text-sm md:text-base">
        ...
        <div className="bg-gradient-to-r from-brand-950/80 to-brand-900/50 backdrop-blur-xl border border-brand-700/30 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 relative overflow-hidden flex flex-col md:flex-row items-center gap-6 md:gap-8">
           <div className="absolute left-0 top-0 w-1/3 h-full bg-brand-primary/5 blur-[50px]"></div>
           <div className="w-24 h-24 md:w-32 md:h-32 shrink-0 rounded-full bg-brand-900 border-4 border-brand-800/50 shadow-[0_0_50px_rgba(0,0,0,0.5)] flex items-center justify-center relative z-10">
              <Star className="w-10 h-10 md:w-12 md:h-12 text-amber-400/50" />
           </div>
           <div className="relative z-10 text-center md:text-left">
              ...
              <h4 className="text-xl md:text-2xl font-light text-white mb-2 md:mb-3">The Mali Ston Risotto</h4>
              <p className="text-brand-300 text-sm md:text-base leading-relaxed max-w-2xl font-light">
        ...
        {/* Booking Card */}
        <div className="bg-brand-primary/10 backdrop-blur-xl border border-brand-primary/30 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 shadow-[0_20px_50px_rgba(2,132,199,0.15)] relative overflow-hidden group">
           ...
           <div className="relative z-10 text-center md:text-left">
             <h4 className="text-xl md:text-2xl font-light text-white mb-1 md:mb-2">Hotel Guest Priority</h4>
             <p className="text-brand-200 text-sm md:text-base max-w-xl font-light">As a treasured guest of Hotel Ostrea, enjoy exclusive priority booking for our highly coveted sea-view terrace tables.</p>
           </div>
           <button onClick={() => alert('Reservation requested for Kapetanova Kuča!')} className="relative z-10 shrink-0 w-full md:w-auto px-6 md:px-8 py-3 md:py-4 bg-brand-primary hover:bg-brand-primary/90 text-white rounded-full text-sm md:text-base font-medium transition-all shadow-[0_0_30px_rgba(2,132,199,0.4)] hover:shadow-[0_0_40px_rgba(2,132,199,0.6)] hover:-translate-y-1 cursor-pointer flex items-center justify-center gap-2 md:gap-3">
             Reserve a Table
